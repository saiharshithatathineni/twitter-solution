...
const tweetAccessVerification = async (request, response, next) => {
  ...
  const getTweetQuery = `SELECT * FROM tweet INNER JOIN follower ON tweet.user_id=
    follower.following_user_id WHERE tweet.tweet_id='${tweetId}' AND follower_user_id='${userId}';`;
...
app.get("/user/following/", authentication, async (request, response) => {
  ...
  const getFollowingUsersQuery = `SELECT name FROM follower INNER JOIN user ON user.user_id
    =follower.following_user_id WHERE follower_user_id='${userId}';`;
...
app.get("/user/followers/", authentication, async (request, response) => {
  const { username, userId } = request;
  const getFollowersQuery = `SELECT DISTINCT name FROM follower INNER JOIN user ON user.user_id
    = follower.follower_user_id WHERE following_user_id='${userId}';`;
...
app.get(
  ...
  async (request, response) => {
    ...
    (SELECT COUNT() FROM reply WHERE tweet_id='${tweetId}') AS replies, date_time as dateTime FROM tweet WHERE 
